$(document).ready(function() {
    ...
    function save_data(state) {
        if (state == 'ADD') {
            url_save = '/karyawan-sakit/store';
        } else {
            url_save = '/karyawan-sakit/update';
        }
    ...
    function form_state(state) {
        switch (state) {
            ...
            case 'ADD_HDR':
                reset_input();
                $("#state").val("ADD");
                $('#title_input').html('Input Data Sakit');
                $('#add_data').show('slow');
                $('#list_data').hide('slow');
                break;
            case 'SAVE_HDR':
            ...
            case 'EDIT_HDR':
                $("#state").val("EDIT");
                $('#title_input').html('Edit Data Sakit');
                $('#add_data').show('slow');
                $('#list_data').hide('slow');
                break;
            case 'REVISI_HDR':
    ...
    $('#save').click(function (event) {
        ...
        if ($('#mulai').val().length == 0) {
            message = 'Tanggal Mulai Sakit Belum Diisi';
        } else if ($('#sampai').val().length == 0) {
            message = 'Tanggal Sampai Sakit Belum Diisi';
        } else {
            message = '';
        }
