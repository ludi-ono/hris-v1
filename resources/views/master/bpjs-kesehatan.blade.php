        ...
        <div class="panel-header bg-warning-gradient">
            <div class="page-inner py-5">
                <div class="text-center align-items-center align-items-md-center flex-column flex-md-row">
                    <div>
                        <h1 class="text-white pb-2 fw-bold">BPJS Kesehatan</h1>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h2 class="text-center">Data BPJS Kesehatan</h2>
                    ...
                    <div id="" class="card full-height">
                        <div class="card-body">
                            <form class="row" id="form_input">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="nama">Potongan BJPS Kesehatan <span style="color: red;">*</span></label>
...
<script type="text/javascript" src="{{ asset('/js/master/bpjs_kesehatan.js') }}"></script>
<script>
    ...
    $("#nav-bpjs-kesehatan").addClass("active");
</script>