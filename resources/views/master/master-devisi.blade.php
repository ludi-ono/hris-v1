        ...
        <div class="panel-header bg-warning-gradient">
            <div class="page-inner py-5">
                <div class="text-center align-items-center align-items-md-center flex-column flex-md-row">
                    <div>
                        <h1 class="text-white pb-2 fw-bold">MASTER DEVISI</h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbl_devisi" class="table table-hover table-striped dt-responsive nowrap" style="width:100%;">
                    ...
                    <div id="" class="card full-height">
                        <div class="card-body">
                            <form class="row" id="form_input">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="nama">Nama Devisi <span style="color: red;">*</span></label>
...
<script type="text/javascript" src="{{ asset('/js/master/devisi.js') }}"></script>
<script>
