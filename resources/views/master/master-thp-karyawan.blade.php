        ...
        <div class="panel-header bg-warning-gradient">
            <div class="page-inner py-5">
                <div class="text-center align-items-center align-items-md-center flex-column flex-md-row">
                    <div>
                        <h1 class="text-white pb-2 fw-bold">THP Karyawan</h1>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h2 class="text-center">Data THP Karyawan</h2>
                                        <div class="table-responsive">
                                            <table id="tbl_thp" class="table table-hover table-striped dt-responsive nowrap" style="width:100%;">
...
<script type="text/javascript" src="{{ asset('/js/master/thp.js') }}"></script>
<script>
