        ...
        <div class="panel-header bg-warning-gradient">
            <div class="page-inner py-5">
                <div class="text-center align-items-center align-items-md-center flex-column flex-md-row">
                    <div>
                        <h1 class="text-white pb-2 fw-bold">MASTER PERUSAHAAN</h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbl_perusahaan" class="table table-hover table-striped dt-responsive nowrap" style="width:100%;">
                    ...
                    <div id="" class="card full-height">
                        <div class="card-body">
                            <form class="row" id="form_input">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h2 class="alert-info font-weight-bold text-center" id="title_input">Tambah Data Perusahaan</h2>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="nama">Nama Perusahaan <span style="color: red;">*</span></label>
                                        <input id="nama_perusahaan" name="nama_perusahaan" class="form-control" type="text" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="kode">Kode Perusahaan <span style="color: red;">*</span></label>
                                        <input id="kode_perusahaan" name="kode_perusahaan" class="form-control" type="text" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
...
<script type="text/javascript" src="{{ asset('/js/master/perusahaan.js') }}"></script>
<script>
    $("#nav-dashboard").removeClass('active');

    $("div#master").siblings('a').attr('aria-expanded', 'true');
    $("div#master").addClass("show");
    $("div#master #master-perusahaan").addClass("active");
