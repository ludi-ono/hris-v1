        ...
        <div class="panel-header bg-warning-gradient">
            <div class="page-inner py-5">
                <div class="text-center align-items-center align-items-md-center flex-column flex-md-row">
                    <div>
                        <h1 class="text-white pb-2 fw-bold">Karyawan - Sakit</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div id="" class="card full-height">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h2 class="text-center">Daftar Izin Sakit</h2>
                    ...
                    <div id="" class="card full-height">
                        <div class="card-body">
                            <form class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h2 class="alert-info font-weight-bold text-center">Detail Data Sakit</h2>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
<script type="text/javascript" src="{{ asset('/js/karyawan/sakit.js') }}"></script>
<script>
    ...
    $("#nav-karyawan-sakit").addClass("active");
</script>