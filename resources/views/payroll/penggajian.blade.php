        ...
        <div class="panel-header bg-warning-gradient">
            <div class="page-inner py-5">
                <div class="text-center align-items-center align-items-md-center flex-column flex-md-row">
                    <div>
                        <h1 class="text-white pb-2 fw-bold">Slip Gaji Karyawan</h1>
                    </div>
                </div>
            </div>
        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbl_slip_gaji_hdr" class="table table-hover table-striped dt-responsive nowrap" style="width:100%;">
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <!-- <h2 class="text-center">Data Devisi</h2> -->
                                    <div class="table-responsive">
                                        <table id="tbl_slip_gaji_detail" class="table table-hover table-striped dt-responsive nowrap" style="width:100%;">
                                            <thead style="color:white;background:#468cff!important">
                                                <tr>
                                                    <th>ID</th>
                                                    <th>NO</th>
...
<script type="text/javascript" src="{{ asset('/js/payroll/slip-gaji.js') }}"></script>
<script>
