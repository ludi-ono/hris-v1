        ...
        <div class="panel-header bg-warning-gradient">
            <div class="page-inner py-5">
                <div class="text-center align-items-center align-items-md-center flex-column flex-md-row">
                    <div>
                        <h1 class="text-white pb-2 fw-bold">Presensi Karyawan</h1>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <!-- <div class="col-md-6 text-right">
                                    <div class="form-group">
                                        <a id="cek_absen" name="cek_absen" style="color:white" class="btn btn-secondary"><i class="fas fa-users"></i> &nbsp; Cek Absensi</a>
                                    </div>
                                </div> -->
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="table-responsive">
                                            <table id="tbl_presensi_hdr" class="table table-hover table-striped dt-responsive nowrap" style="width:100%;">
                    ...
                    <div id="" class="card full-height">
                        <div class="card-body">
                            <form class="row" id="form_input">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h2 class="alert-info font-weight-bold text-center" id="title_input">Generate Presensi</h2>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="bulan">Pilih Bulan Presensi</label>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <center>
                                            <h2>Periode Tgl : <span class="periode_tgl"></span></h2>
                                        </center>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <!-- <h2 class="text-center">Data Devisi</h2> -->
                                        <div class="table-responsive">
                                            <table id="tbl_presensi_dtl" class="table table-hover table-striped dt-responsive nowrap" style="width:100%;">
                                                <thead style="color:white;background:#468cff!important">
                                                    <tr>
                                                        <th>ID</th>
                                                        <th>NO</th>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-body" style="overflow: hidden;">
                        <h4 style="font-weight:bold;color:#407290;text-shadow: 1px grey; text-align:center;" class="modal-title">Detail Presensi Periode : </h4>
                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <!-- <h2 class="text-center">Data Devisi</h2> -->
                                    <div class="table-responsive">
                                        <table id="tbl_presensi_detail" class="table table-hover table-striped dt-responsive nowrap" style="width:100%;">
                                            <thead style="color:white;background:#468cff!important">
                                                <tr>
                                                    <th>ID</th>
                                                    <th>NO</th>
...
<script type="text/javascript" src="{{ asset('/js/payroll/presensi.js') }}"></script>
<script>
    ...
    $("#nav-generate-presensi").addClass("active");
</script>