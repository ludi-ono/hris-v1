        ...
        <div class="panel-header bg-warning-gradient">
            <div class="page-inner py-5">
                <div class="text-center align-items-center align-items-md-center flex-column flex-md-row">
                    <div>
                        <h1 class="text-white pb-2 fw-bold">Lembur Karyawan</h1>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div id="" class="card full-height">
                        <div class="card-body">
                            <form class="row" id="form_input">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <h2 class="alert-info font-weight-bold text-center" id="title_input">Generate Lembur</h2>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
...
<script type="text/javascript" src="{{ asset('/js/payroll/lembur.js') }}"></script>
<script>
    ...
    $("#nav-generate-lembur").addClass("active");
</script>